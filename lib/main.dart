...
class Iphonese1Widget extends StatelessWidget {
      ...
      child: Stack(
        ...
        top: 547,
        left: 106,
        child: Text('Elearning TI Poliwangi', textAlign: TextAlign.left, style: TextStyle(
      ...
      image : DecorationImage(
          image: AssetImage('assets/images/Ti1.png'),
          fit: BoxFit.fitWidth
      ),
  )
      )
      ...
      color : Color.fromRGBO(54, 51, 46, 1),
        ...
        top: 416,
        left: 128,
        child: Text('masukan nim', textAlign: TextAlign.left, style: TextStyle(
        ...
        top: 460,
        left: 111,
        child: Text('masukan password', textAlign: TextAlign.left, style: TextStyle(
        color: Color.fromRGBO(168, 168, 168, 1),
        fontFamily: 'Inder',
        fontSize: 10,
        letterSpacing: 0 /*percentages not used in flutter. defaulting to zero*/,
